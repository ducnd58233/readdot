...
const PDFViewer = forwardRef<PDFViewerRef, PDFViewerProps>(
  ({ fileUrl, highlights, onAddHighlight, selectedColor }, ref) => {
    ...
    // Expose scrollToHighlight method to parent
    useImperativeHandle(ref, () => ({
      scrollToHighlight: (highlight: Highlight) => {
        const pageElement = pageRefs.current.get(highlight.pageNumber);
